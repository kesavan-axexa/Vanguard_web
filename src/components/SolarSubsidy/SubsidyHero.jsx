      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 my-2">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div
            ...
            animate="visible"
          >
            <p className="text-base sm:text-md md:text-lg text-white mb-8 leading-relaxed font-light tracking-wide max-w-4xl mx-auto px-4  lg:text-center">
              A solar subsidy is a financial incentive provided by the
              government to encourage individuals, businesses, and industries to
              adopt solar energy. It helps reduce the upfront cost of installing
              solar power systems, making renewable energy more accessible and
              affordable. These subsidies can be in the form of direct financial
              assistance, tax incentives, rebates, or zero-collateral loans.
            </p>
          </motion.div>
        </div>
      </div>
